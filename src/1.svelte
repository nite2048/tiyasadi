<script>
     const cake = new URL('./assets/caki.png', import.meta.url).href;
     const hat = new URL('./assets/hat.png', import.meta.url).href;
     const ballon = new URL('./assets/ballon.png', import.meta.url).href;
     const cat = new URL('./assets/catt.png', import.meta.url).href;
     const gift = new URL('./assets/gift.png', import.meta.url).href;
     const gift3 = new URL('./assets/gift3.png', import.meta.url).href;
     const star = new URL('./assets/starme.png', import.meta.url).href;
...
<main class="blur-panel vignette">
     <div id="cake">
          <div id="table">
               ...
               <img id="cat" class="glow image-glow" src="{cat}"/>
               <img id="gift" class="glow image-glow" src="{gift3}"/>
               <img id="star" class="glow image-glow" src="{star}"/>

          </div>
          <span id="sub">(dw it's homemade ⪩⪨꙳)</span>
          <span id="hed">happy birthday</span>
